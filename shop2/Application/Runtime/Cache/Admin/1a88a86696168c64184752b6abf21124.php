...
<form action="<?php echo U('Goods/handlerBrand');?>" method="post" enctype="multipart/form-data" />
    <div class="left_add" style="border:1px solid snow;">
        ...
        <ul class="add_conent">
            ...
            <li class=" clearfix">
                ...
                <div  class="div_visibility" style="margin-left:90px;"><label class="label_name">12312</label></div>
            </li>
            <li class=" clearfix">
                <label class="label_name">显示状态：</label> 
                <label>
                    <input name="show" type="radio" class="ace" checked="checked" value="1">
