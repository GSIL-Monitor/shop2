...
<div class="Competence_add_style clearfix">
  <div class="left_Competence_add">
   <div class="title_name">修改角色</div>
    ...
    <form action="<?php echo U('Rbac/editRoleData');?>"  method="post" id="form1">
   ...
   <div class="Button_operation" >
				...
				<button  class="btn btn-secondary  btn-warning" type="button"><a href="<?php echo U('Rbac/role');?>"><i class="fa fa-reply"></i> 返回上一步</a></button>
