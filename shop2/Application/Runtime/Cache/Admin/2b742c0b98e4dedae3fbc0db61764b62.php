...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<!--[if lt IE 9]>
		<script src="/shop2/Public/assets/js/html5shiv.js"></script>
		<script src="/shop2/Public/assets/js/respond.min.js"></script>
		<![endif]-->
        		<!--[if !IE]> -->
...
<div class="page-content clearfix">
 <div class="alert alert-block alert-success">
  ...
  <i class="icon-ok green"></i>欢迎使用<strong class="green">后台管理系统<small>(v1.2)</small></strong>,你本次登陆时间为<?php echo ($time); ?>，登陆IP:<?php echo ($ip); ?>	
 </div>
