...
<div class="page-content clearfix">
  <div id="brand_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="<?php echo U('Goods/addbrand');?>"  title="添加品牌" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加品牌</a>
  ...
  <?php if(is_array($pageData)): foreach($pageData as $key=>$vo): ?><tr>
          ...
          <a title="编辑" href="<?php echo U('edit', [id=>$vo['id']]);?>"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
  ...
  layer.confirm('确认要停用吗？',
    ...
    function(index){
      ...
      $.ajax({
        ...
        url: "<?php echo U('Goods/handlerStatusData');?>",
        type: "post",
  ...
  layer.confirm('确认要启用吗？',
    ...
    function(index){
      ...
      $.ajax({
        ...
        url: "<?php echo U('Goods/handlerStatusDatas');?>",
        type: "post",
        data: "id="+id+"&status="+data,
        success: function (msg) {
...
function del(obj, id) {
    ...
    layer.confirm('确认要删除吗？',function(index){
        ...
        $.ajax({
            url: "<?php echo U('Goods/delBrandData');?>",
            type: "post",
            data: "id="+id,
            success: function (msg) {
