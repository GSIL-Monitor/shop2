 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="add.html" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
            ...
            <tbody>
                <tr class="1">
                    ...
                    <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">小米 Min1 全网通 高配版 3GB内存 64GB ROM 金色 移动联通电信4G手机Y</u></td>
                    ...
                    <td class="td-manage">
                    <a onClick="member_stop(this,1)"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a> 
...
function member_stop(obj,id){
	...
	layer.confirm('确认要停用吗？',function(index){
		$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" class="btn btn-xs " onClick="member_start(this,gid)" href="javascript:;" title="启用"><i class="icon-ok bigger-120"></i></a>');
...
function member_start(obj,id){
	...
	layer.confirm('确认要启用吗？',function(index){
		$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" class="btn btn-xs btn-success" onClick="member_stop(this,gid)" href="javascript:;" title="停用"><i class="icon-ok bigger-120"></i></a>');
