    ...
    <div class="widget-header header-color-green2">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             <li><i class="orange  fa fa-user-secret"></i><a href="#">全部(<?php echo ($count); ?>)</a></li>
             <li><i class="fa fa-diamond pink "></i> <a href="#">普通用户(<?php echo ($commonUserNum); ?>)</a></li>
             <li><i class="fa fa-diamond red "></i><a href="#">VIP(<?php echo ($vipUserNum); ?>)</a> </li>
             <li><i class="fa fa-diamond grey "></i><a href="#">钻石用户(<?php echo ($diamondUserNum); ?>)</a></li>
        </ul><!-- 
        <ul id="option">
             <li><a href="#">全部(<?php echo ($count); ?>)</a></li>
             <li><a href="#">普通用户(<?php echo ($commonUserNum); ?>)</a></li>
             <li><a href="#">VIP(<?php echo ($vipUserNum); ?>)</a> </li>
             <li><a href="#">钻石用户(<?php echo ($diamondUserNum); ?>)</a></li>
        </ul> -->
  </div>
  </div>
  </div>  
   ...
   <div class="Statistics_style" id="Statistic_pie">
     ...
     <span class="Statistic_title Statistic_btn"><a title="隐藏" class="top_close_btn">隐藏</a></span>
      ...
      <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
            ...
            <td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','500','400')"><?php echo ($vo["account"]); ?></u></td>
            <td>
              <?php
 if ($vo['sex'] == 0) { echo '女'; } else if ($vo['sex'] == 1) { echo '男'; } else { echo '保密'; } ?>
            </td>
...
/**************/
     require.config({
            paths: {
                echarts: '/shop2/Public/assets/dist'
            }
        });
        require(
            [
