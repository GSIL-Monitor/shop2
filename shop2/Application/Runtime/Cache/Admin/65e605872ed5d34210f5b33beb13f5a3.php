...
<div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <form action="<?php echo U('User/index');?>" method="get">
        <ul class="search_content clearfix">
         <li><label class="l_f">用户名称</label><input name="name" type="text"  class="text_add" placeholder="输入会员名称"  style=" width:400px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="#" id="member_add" class="btn btn-warning"><i class=""></i>会员列表</a>
       </span>
	...
	<tbody>
		<?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr>
	          ...
	          <td>
	          	<?php
 if ($vo['sex'] === '0') { echo '女'; } else if ($vo['sex'] == 1) { echo '男'; } else if($vo['sex'] == 2){ echo '保密'; } ?>
	          </td>
	          <td><?php echo ($vo["phone"]); ?></td>
	          <td><?php echo ($vo["email"]); ?></td>
	          <td class="text-l"><?php echo ($vo["score"]); ?></td>
 ...
 if ($vo['role'] == 1) { echo '普通用户'; } else if ($vo['role'] == 2) { echo 'VIP'; } else { echo '钻石用户'; } ?>
            ...
            <?php elseif(($vo['status'] == 2)): ?>
	          ...
	          <a title="编辑" href="<?php echo U('User/editUser',['id'=>$vo['id']]);?>"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
  ...
  layer.confirm('确认要停用吗？',
    ...
    function(index){
      ...
      $.ajax({
        ...
        url: "<?php echo U('User/handlerStatusData');?>",
        type: "post",
