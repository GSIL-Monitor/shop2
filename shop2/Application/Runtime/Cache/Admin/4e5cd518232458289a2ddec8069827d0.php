  ...
  <div class="left_Competence_add">
   <div class="title_name">添加管理员</div>
    ...
    <form action="<?php echo U('Rbac/addAdmin');?>"  method="post" id="form1">
        ...
        <div class="form-group">
            <div class="col-sm-9">用户名&nbsp;&nbsp; <input type="text" id="keke" placeholder=""  value="<?php echo ($groupData['title']); ?>" name="name" class="col-xs-10 col-sm-5"></div>
        </div><br>    
        <div class="form-group">
            <div class="col-sm-9">密码&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<input type="password"  placeholder=""  value="<?php echo ($groupData['title']); ?>" name="password" class="col-xs-10 col-sm-5"></div>
        </div><br>    
        <div class="form-group"> 
            <div class="col-sm-9">重复密码<input type="password"  placeholder=""  value="<?php echo ($groupData['title']); ?>" name="password2" class="col-xs-10 col-sm-5"></div>
        </div><br>  
         <div class="form-group">
   ...
   <div class="Assign_style">
    ...
    <?php if(is_array($group)): foreach($group as $key=>$vo): ?><div class="form-group">
            <div class="col-sm-9"><input type="CheckBox" id="form-field-1" placeholder=""  value="<?php echo ($vo['id']); ?>" name="group[]" class="col-xs-10 col-sm-5"><?php echo ($vo['title']); ?></div>
