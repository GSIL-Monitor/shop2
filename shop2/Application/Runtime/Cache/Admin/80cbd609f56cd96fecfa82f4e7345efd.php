...
<body>
<form action="<?php echo U('Goods/test2');?>" method="post" enctype="multipart/form-data">
	<div>
  <input type="hidden" name="id" value="<?php echo ($id); ?>" id="gid">
	<div class="clearfix cl ettr">
       ...
       &nbsp;&nbsp;<select id="color_select" class="select" name="color" size="1" id="color_type" style="border-radius:5px;">
          ...
          <option value="玫瑰红" color="#F56363">玫瑰红</option>
          <option value="黑色" color="#111111">黑色</option>
          <option value="橙色" color="#FF7F00">橙色</option>
          <option value="浅桔黄" color="#E47833">浅桔黄</option>
          <option value="油绿" color="#6B8E23">油绿</option>
          <option value="松柏绿" color="7FFF00">松柏绿</option>
          <option value="蔚蓝色" color="#33FFFF">蔚蓝色</option>
          <option value="莹白色" color="#E3F9FD">莹白色</option>
          <option value="莹绿色" color="#00E079">莹绿色</option>
          <option value="莹黄色" color="#EAFF56">莹黄色</option>
        </select>
    </div>
    <label id="imgs">
	...
	<div class="ettr">
       ...
       &nbsp;&nbsp;<select class="select" name="size1" size="1" id="size_type" style="width:120px;
        border-radius:5px;">
          ...
          <option value="36(鞋)">36(鞋)</option>
          <option value="38">38</option>
          <option value="40">40</option>
          <option value="42">42</option>
          <option value="27(裤)">27(裤)</option>
