...
<head>
    ...
    <script type="text/javascript">
        ...
        <link rel="stylesheet" type="text/css" href="/shop2/Public/Home/pc/css/page/account/setPassword.css"/>       
...
<!--     
  ...
  <div class="settings_box"> 
    ...
    <fieldset class="setPersonal">
        <form id="setPasswordForm" method="post" action="<?php echo U('Person/doChangePassword');?>">  
