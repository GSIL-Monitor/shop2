    ...
    <div class="mod_list clearfix">
        <div class="mod_item w1200" data-id="4634908" data-width="1200" data-type="topBanner" data-title="$commonTopBanner.layoutname">
            <div class="mod_cont topbanner">
                <a class="shop_bg_img" href="shop.html#110fni1q" data-src="http://imgtest-dl.meiliworks.com/pic/_o/28/ce/2f023f9e3022e39950807e7e2170_2000_120.c5.jpg" style="background: url(http://imgtest-dl.meiliworks.com/pic/_o/28/ce/2f023f9e3022e39950807e7e2170_2000_120.c5.jpg) center no-repeat"></a>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="clearfix main-box">
                                    ...
                                    <dl class="clearfix property-box">
                                        ...
                                        <dd class="property-extra fr">
                                            <span class="mr10">评价：<span class="num"></span></span>
                            ...
                            <div id="J_RatesBuyer">
                                ...
                                <div class="rates-buyer">
                                    ...
                                    <div class="comment-content">
                                        ...
                                        <!-- 列表 -->
                                        <div id="bb" class="comments" style="display:none;">
                                        </div>
                                </div>
                            </div>
...
$(function(){ 
    $('.momo').on('click','li',function (){
        ...
        // if ($(this).parent().parent().parent().siblings().find('li[class="c"]').size() == 1) {
            // var color = $('.J_StyleList').find('li[class="c"]').attr('key');

            // var size = $('.J_SizeList').find('li[class="c"]').attr('title');

            // alert(color);
            // alert(size);
            $(this).addClass('check').siblings().removeClass('check');

            // console.log($('.J_StyleList').find('.check').length);
            // console.log($('.J_SizeList').find('.check').length);
         if( $('.J_StyleList').find('.check').length == 1 && $('.J_SizeList').find('.check').length== 1) {
    //             alert($('.J_StyleList').find('.check').attr('title')+$('.J_SizeList').find('.check').attr('title'));
                ...
                $.ajax({
                    ...
                    success:function (msg) {
                        $('.aabb').remove();
                        console.log(msg.num[0]['num']);
                        $('.J_GoodsStock').after(
                            '<span class="aabb" data-stock="'+msg.num[0]['num']+'"style="color:red;">库存为'+msg.num[0]['num']+'件</span>'
                            );
    ...
    // var res = $('.J_StyleList').find('li[class="c"]').attr('key');
    // alert(res);

    // $('#J_BuyNow').click(function () {
    //     var i = $('.J_StyleList').find('li[class="c"]').size();
    //     var j = $('.J_SizeList').find('li[class="c"]').size(); 
    //     if( i == 1 && j == 1) {
    //         var color = $('.J_StyleList').find('li[class="c"]').attr('key');
            ...
            console.log(color);
                ...
                $.ajax({
                    ...
                    success:function (msg) {
                       ...
                       // that.attr('isrequested','true');
                    },
                    error:function () {
                        alert(1);
                    },
                    dataType:'json',
                    // '<?php echo U("Goods/handlerAjaxSize");?>',
                    //  {'color':color},
                    //  function (msg) {
                    //    var res = that.parseJSON(msg)
                    //    console.log(res.pic);
                    // },
                    // 'json',
...
<script>
    $('.num-add').click(function (){
        ...
        var stock = $('#J_GoodsNum').attr('data-stock');
        if (buynum > stock) {
            // $('.J_GoodsStock').next().remove();
            $('.J_GoodsStockTip').attr('style','display:block');
        }
    })
</script>
...
// console.log(data_arr[0]);return false ;
