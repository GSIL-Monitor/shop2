...
<!--     
     ...
     <div class="settings_box">
            ...
            <form id="setPersonForm" method="get" onsubmit="return false" action="<?php echo U('Person/addUserDetail');?>">
                <input type="hidden" name="uid" value="<?php echo ($user['uid']); ?>">
                <div class="form-list">
                    <label class="account-label">注册邮箱</label>
                    <input id="register_mail" name="register_mail" autocomplete="off" class="l_ipt input_disable" type="text" value="<?php echo ($user['email']); ?>" disabled="disabled" />
                    <strong></strong> 
                </div>    
                <div class="form-list">
                    <label class="account-label">手机号码</label>
                    <input id="register_mail" name="phone" autocomplete="off" disabled="disabled" class="l_ipt" value="<?php echo ($user['phone']); ?>"type="text" />
                    <strong></strong> 
                </div>
             
                <div class="form-list">
                    <label class="account-label">昵称</label>
                    <input id="nickname" name="name" autocomplete="off" disabled="disabled" class="l_ipt" type="text" value="<?php echo ($user['name']); ?>" />
                    <strong></strong>
                </div>   
                <div class="form-list">
                    <label class="account-label">总积分</label>
                    <input id="nickname" name="name" autocomplete="off" disabled="disabled" class="l_ipt" type="text" value="<?php echo ($user['score']); ?>" />
                    <strong></strong>
                </div>
                <div class="gender" id="gender">
                    <label class="account-label">性别</label>
                    <input name="sex" id="female" type="radio" value="0" disabled="disabled" <?=$user['sex']=='0'?'checked':''?> class="regular-radio" />
                    <label for="female" class="regular-radio-label"></label>
                    <span>女</span>
                    <input name="sex" id="male" type="radio" value="1" disabled="disabled" class="regular-radio" <?=$user['sex']=='1'?'checked':''?>/>
                    <label class="regular-radio-label" for="male"></label>
                    <span>男</span>  
                    <input name="sex" id="unknown" type="radio" value="2" disabled="disabled" class="regular-radio"  <?=$user['sex']=='2'?'checked':''?>/>
                    <label class="regular-radio-label" for="male"></label>
                    <span>保密</span>
                    <strong></strong> 
                </div>
                ...
                <div class="form-list" id="birthday-list">   
                    ...
                    <input id="birthday" readonly class="laydate-icon"  disabled="disabled" name="birth" autocomplete="off" class="l_ipt" type="text" value="<?php echo ($user['birth']); ?>" onfocus="HS_setDate(this)" />
                    <strong></strong>
                </div>
           
               <a href="<?php echo U('Person/setPersonal');?>" ><button type="button" class="ext_submit">修改资料</button></a>
