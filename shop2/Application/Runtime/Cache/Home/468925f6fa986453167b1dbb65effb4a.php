                    ...
                    <div class="fl goods-info goods-info-tuan-pre" id="J_GoodsInfo">
                        <div class="info-box">
                            ...
                            <div class="goods-prowrap goods-main">
                                ...
                                <dl class="clearfix event-box">    
                                    <dd style="background: url(http://s2.mogucdn.com/p1/160329/upload_ifrtan3egaytmojzg4zdambqhayde_540x68.png) 0 0 no-repeat;">
                                        ...
                                        <span class="event-time-left" id="J_CountDown" cut-time="<?php echo ($saletime); ?>">
                            ...
                            <div class="goods-prowrap goods-sku" id="J_GoodsSku">
                                ...
                                <?php if ($saletime > 0) {?>
                                    <a href="javascript:;" class="fl mr10 buy-btn buy-now">等待抢购</a>
                                    <input type="hidden" value="nodapei" id="dapeiShow">
                                <?php } else {?>
                                    <a href="javascript:;" class="fl mr10 buy-btn buy-now  buy-nowtime">立刻抢购</a>
                                    <input type="hidden" value="nodapei" id="dapeiShow">
                                <?php }?>
                                </div>
                            </div>
                            <div class="goods-social clearfix">
                                <div class=" fav  item" goodsid="0" tradeitemid="1fxighu" tid="0"><b></b><span class="fav-num">收藏</span></div>
                    ...
                    <div class="tabbar-box">
                        <ul class="tabbar-list clearfix">
                            ...
                            <li data-panels="rates" data-hasnav="false">
                                <a id="aa">累计评价<em><?php echo ($count); ?></em></a>
                            </li>
...
<!--定时刷新页面-->
<script>
    var time = $('#J_CountDown').attr('cut-time');
    console.log(time);
 ...
 <script>
 	$('.buy-nowtime').click(function() {
       ...
       if ($('.J_StyleList').find('.check').length ==1 && $('.J_SizeList').find('.check').length == 1) {
            ...
            $.ajax({
                type:'get',
                url:'<?php echo U("Goods/handlerCuXiaoGoodsData");?>',
                data:{
                    stock:stock,
                    buynum:buynum,
                    gid:data_arr[0],
