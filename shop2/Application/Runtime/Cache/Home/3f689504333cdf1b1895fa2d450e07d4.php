...
<link rel="stylesheet" type="text/css" href="/shop2/Public/Home/pc/css/page/account/common.css?1607171726.25"/><link rel="stylesheet" type="text/css" href="/shop2/Public/Home/pc/css/page/account/setAvatar.css?1607171726.25"/>     
<script type="text/javascript" src="/shop2/Public/Home/pc/jsmin/fml.js?1" ></script>   
...
<!--     
    ...
    <div class="settings_box"> 
        ...
        <fieldset> 
            <div class="setAvatar"> 
                <form id="setAvatar" method="post" action="<?php echo U('Person/setAvatar');?>"  enctype="multipart/form-data"> 
                    ...
                    <?php if(empty($pic)): ?><img src="/shop2/Public/Home/img/03.jpg" class="original" />
                    <?php else: ?>
                    <img src="/shop2/Public/Uploads/<?php echo ($pic); ?>" class="original"/><?php endif; ?>
