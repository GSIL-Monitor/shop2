...
<script>    fml.setOptions({'sversion' : '1607171726.25','defer' : true ,'modulebase' : 'pc/jsmin/'});   var Meilishuo = {
    "config": {
...
<body>
    ...
    <div class="wrap">    
        ...
        <div class="userContain" data-link="/search/catalog/10057049">  
            <div class="choice">        
                ...
                <?php if(is_array($fenlei)): foreach($fenlei as $key=>$v): ?><a href="<?php echo U('List/search', ['id'=>$v['id'],'bqname'=>$v['name']]);?>">
            ...
            <div class="styleCatalog">              
                <div class="styleContainer">                            
                    ...
                    <p class="styleNameWrap" data-choice=''>       
                        <?php if(is_array($typedatas)): foreach($typedatas as $key=>$vo): ?><a href="<?php echo U('List/search', ['tid'=>$vo['id'],'bid'=>$bid,'keyword'=>$keyword]);?>"  class="styleName" data-isClick='0' data-catePropId="10000"><span class="choiceBox"></span><?php echo ($vo['name']); ?></a><?php endforeach; endif; ?>
                    </p>                                      
            ...
            <div class="styleCatalog"   style="padding:2px 0">              
                <div class="styleContainer" style="padding:2px 0">                                        
                     ...
                     <span class="styleNameWrap" >                                               
                        <?php if(is_array($brandShow)): foreach($brandShow as $key=>$vo): ?><a href="<?php echo U('List/search', ['bid'=>$vo['id'],'tid'=>$id,'keyword'=>$keyword]);?>"  class="styleName"  ><img src="/shop2/Public/Uploads/<?php echo ($vo['logo']); ?>" title="<?php echo ($vo['name']); ?>" width="76px"  height="37px" ></a><?php endforeach; endif; ?>            
                    </span>                                                                 
                </div>                 
            </div><?php endif; ?>     
            ...
            <div class="orderInfo" data-checkedSort="pop">               
                ...
                <!-- <a href="<?php echo U('list',['order' => 'price desc','id' => $id]);?>" class="fashion both"  ><span>价格&#x25bc;</span></a>   -->
                 ...
                 <span class="priceArrow"></span>              
                    ...
                    <!-- 价格部分 -->       
            <div class="priceWrap"> 
                <form action="<?php echo U('List/search');?>">     
                <input class="minPrice" type="text" placeholder="￥" name="num1" >            
                <input type="hidden" name="bid" value="<?php echo ($bid); ?>">            
                <input type="hidden" name="tid" value="<?php echo ($id); ?>">              
                <span>~</span>              
                <input class="maxPrice" type="text" placeholder="￥" name="num2" >          
    ...
    <div id="com-foot">  
     ...
     <!-- // <script type="text/javascript" src="/shop2/Public/Home/js/jquery-1.12.3.min.js"></script> -->
            <!-- // <script type="text/javascript" src="/shop2/Public/js/jquery-1.11.0.min.js"></script> -->
